...
exports.default = function (program) {
  program.command('android [project-dir]').description('Opens your app in Expo on a connected Android device').allowNonInteractive().allowOffline().asyncActionProjectDir(action);
};
