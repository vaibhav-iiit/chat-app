      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 6;
            return (_inquirerAsync || _load_inquirerAsync()).default.promptAsync([{
              type: 'input',
              name: 'sendTo',
...
function _load_inquirerAsync() {
  return _inquirerAsync = _interopRequireDefault(require('inquirer-async'));
}
